...
function MarketplacePage() {
  ...
  return <AppShell title="Marketplace">
    <div className="mb-7 flex flex-wrap items-end justify-between gap-4"><div className="max-w-3xl"><p className="font-display text-2xl font-semibold tracking-tight">Marketplace do workspace</p><p className="mt-2 text-sm leading-relaxed text-muted">Instale agentes operacionais e conecte capacidades nativas ao contexto selecionado. Cada instalação fica isolada neste workspace.</p></div><Link to="/marketplace/installed" className="text-sm font-medium text-accent hover:underline">Minhas Instalações</Link></div>
